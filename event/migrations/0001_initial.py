    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activity_type', models.CharField(choices=[('view', 'View'), ('comment', 'Comment'), ('like', 'Like'), ('media_upload', 'Media Upload'), ('rsvp', 'RSVP'), ('share', 'Share')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('inactivated_at', models.DateTimeField(blank=True, null=True)),
                ('status', models.CharField(choices=[('interested', 'Interested'), ('not_interested', 'Not Interested'), ('pending', 'Pending'), ('declined', 'Declined')], default='interested', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='EventComment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('workshop', 'Workshop'), ('seminar', 'Seminar'), ('conference', 'Conference'), ('meetup', 'Meetup'), ('webinar', 'Webinar'), ('social', 'Social Event'), ('networking', 'Networking'), ('other', 'Other')], default='other', max_length=20)),
                ...
                ('event_logo', models.ImageField(blank=True, null=True, upload_to='events/logo/')),
